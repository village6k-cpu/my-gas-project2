...
assert(route.includes('"Access-Control-Allow-Origin": "*"') && route.includes("export async function OPTIONS"), "공개 홈페이지가 영상 목록 API를 직접 읽을 수 있어야 한다");
...
assert(library.includes("https://www.village6k.co.kr/guide"), "내 예약의 전체 영상 검색은 공식 홈페이지로 연결되어야 한다");
