...
export function itemToRow(e: EquipmentItem, tradeId: string, sort: number): any {
  ...
  return {
    ...
    actual_name: e.actualName ?? null,
    actual_taken_qty: e.actualTakenQty ?? null,
...
export function tradeFromRow(r: any, items: EquipmentItem[]): Trade {
  return {
    ...
    kakaoConversationChecked: !!r.kakao_conversation_checked,
...
export function tradeToRow(t: Trade): any {
  return {
    ...
    kakao_conversation_checked: !!t.kakaoConversationChecked,
