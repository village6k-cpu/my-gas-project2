...
import { Today, Timeline, Chat, Chart, Clipboard, Archive, Academy } from "@/components/icons";

// 다 동등한 7개 섹션 — 하나의 통합앱. 상태기반 전환(라우트 X).
...
export const NAV_ITEMS: { key: NavKey; label: string; href: string; Icon: ComponentType<{ className?: string }> }[] = [
  ...
  { key: "dojang", label: "훈련소", href: "/dojang", Icon: Academy },
];
