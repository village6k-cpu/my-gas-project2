...
//
// 설계 원칙:
// - Village Brain(사업 참모용)과 의도적으로 분리 — 사장님 결정(2026-08-12).
...
const LEDGER_HEADER = [
  ...
  '(처리·판단·사실관계와 함께 실제 직원의 자연스러운 문장 길이·호칭·표현을 배우는 교정 원장이다. 무례함은 복제하지 않고 AI식 친절 문구를 덧붙이지 않는다 — 사장 지시 2026-08-17.)',
  ''
].join('\n');
